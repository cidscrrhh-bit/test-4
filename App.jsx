...
const BRAND = {
  name: "Muebles Deutschland",
  whatsappNumber: "59162137080", // número del usuario
  email: "ventas@mueblesdeutschland.bo", // opcional
  primary: "#000000",
  secondary: "#dd0000",
  accent: "#ffcc00",
...
// Tarifas de envío referenciales (en Bs)
    ...
    <div className="min-h-screen bg-neutral-50 text-neutral-900">
      ...
      <header className="sticky top-0 z-40 backdrop-blur bg-white/70 border-b border-neutral-200">
        <div className="max-w-7xl mx-auto flex items-center justify-between px-4 py-3">
          <div className="flex items-center gap-3">
            ...
            <span className="ml-2 hidden md:inline text-sm text-neutral-500">Proyecto Flatpack</span>
          </div>
      ...
      <footer className="bg-neutral-900 text-neutral-200">
        <div className="max-w-7xl mx-auto px-4 py-10 grid md:grid-cols-3 gap-6">
          <div>
            <div className="font-bold text-lg">{BRAND.name}</div>
            <p className="text-sm text-neutral-400 mt-2">Diseñamos y fabricamos muebles de calidad, listos para armar, con envío a todo el país.</p>
          </div>
          <div>
